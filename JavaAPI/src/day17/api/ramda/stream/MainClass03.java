...
public class MainClass03 {
	...
	public static void main(String[] args) {
		...
		System.out.println(r4.getAsInt()); //옵셔널 정수형에서 정수값 반환
		
		System.out.println("---------------------------------------------------------------------");
		
		//list에서 50보다 큰 값만 중복없이 저장하는 새로운 리스트 생성
		
		//list.stream().distinct().filter(a -> a >= 50).map(a -> a).forEach(a -> System.out.print(a + " "));
		...
		IntStream.rangeClosed(1, 10).forEach(a -> System.out.println(a + " ")); //포함해서 정수 스트림 반환
