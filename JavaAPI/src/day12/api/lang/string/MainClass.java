...
//		String str = new String(arr);
		...
		//contains - 문자열에 내가 찾는게 있으면 true, 없으면 false
		if(str.contains("안녕")) {
			System.out.println("문자에 값이 존재함");
		}
		...
		System.out.println(str.substring(9, 17)); // 9이상 17미만 추출(인덱스번호로 계산!?)
		...
		System.out.println(str.compareTo("홍길가")); //양수 - str이 홍길가보다 사전등재순 뒤에 위치함
		...
		//기본타입을 문자열로 변경(아래 두 방법 모두 결과값은 같다!)
